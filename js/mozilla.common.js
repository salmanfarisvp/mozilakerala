...
function init_mobile_download_links() {
    ...
    if (site.platform === "ios") {
        $('a[href^="https://itunes.apple.com/"]').each(function() {
            $(this).attr("href", $(this).attr("href").replace("https://", "itms-apps://"))
        })
    }
}
...
if (typeof Mozilla === "undefined") {
    ...
    Client.getFirefoxDetails = function(callback) {
        ...
        var fallback = function() {
            onRetrieved(false, userVer, "release")
        };
...
Mozilla.ImageHelper.isHighDpi = function() {
    if (Mozilla.ImageHelper.is_high_dpi === null) {
        var media_query = "(-webkit-min-device-pixel-ratio: 1.5)," + "(-o-min-device-pixel-ratio: 3/2)," + "(min--moz-device-pixel-ratio: 1.5)," + "(min-resolution: 1.5dppx)";
        Mozilla.ImageHelper.is_high_dpi = window.devicePixelRatio > 1 || window.matchMedia && window.matchMedia(media_query).matches
    }
...
(function() {
    ...
    NavMain.init = function() {
        ...
        NavMain.mainMenuItems.bind("mouseover focusin", NavMain.handleFocusIn).bind("mouseout focusout", NavMain.handleFocusOut).each(NavMain.initSubmenu);
    ...
    NavMain.handleFocusIn = function() {
        ...
        item.addClass("hover").find('[aria-expanded="false"]').attr("aria-expanded", "true")
    };
    NavMain.handleFocusOut = function() {
        NavMain.previousMenuItem = $(this);
        NavMain.previousMenuItem.delay(100).queue(function() {
            if (NavMain.previousMenuItem) {
                NavMain.previousMenuItem.clearQueue().removeClass("hover").find('[aria-expanded="true"]').attr("aria-expanded", "false");
                NavMain.previousMenuItem = null;
    ...
    NavMain.enterSmallMode = function() {
        ...
        NavMain.mainMenuLinks.addClass("submenu-item").unbind("click", NavMain.handleSubmenuClick);
    ...
    NavMain.openSmallMenu = function() {
        ...
        NavMain.mainMenuLinks.addClass("submenu-item").on("click", NavMain.handleSubmenuClick).on("keydown", NavMain.handleSubmenuKeypress);
    ...
    NavMain.closeSmallMenu = function() {
        ...
        NavMain.mainMenuLinks.addClass("submenu-item").off("click", NavMain.handleSubmenuClick).off("keydown", NavMain.handleSubmenuKeypress);
